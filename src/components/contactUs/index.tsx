                ...
                <div className="mt-10 justify-between gap-8 md:flex">
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                className="mt-5 rounded-lg bg-secondary-400 hover:bg-secondary-300 px-20 py-3 transition duration-500 hover:text-white"
                            >
                                SUBMIT
                            </button>
                        </form>
                    ...
                    >
                        <div className="w-full relative before:absolute before:-bottom-20 before:-right-10 before:z-[0] md:before:content-backgroundSparkles">
                            <img
