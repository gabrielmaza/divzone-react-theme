...
const Main = ({ setSelectedPage }: Props) => {
    ...
    return (
        <section
            id='home'
            className='gap-16 bg-gray-950 py-10 md:h-full md:pb-0'
        >
            ...
            >
                ...
                <div className="z-10 mt-32 md:basis-3/5">
                    ...
                    >
                        <div className="relative">
                            <div className="before:absolute before:-top-40 before:-left-20 before:z-[-1] md:before:content-backgroundSparkles">
                ...
                <div className="relative flex basis-3/5 justify-center z-10 md:ml-40 md:mt-16 md:justify-items-end h-[280px] xs:h-[410px]">
                    <img src={HomePageGraphic} alt="Home page graphic" className='absolute right-1/2 translate-x-[50%] md:right-0 md:translate-x-0 top-10 md:top-0 h-full md:h-[460px] w-auto object-contain' />
                </div>
            </motion.div>
            {/* HOW DO WE DO IT? */}
            <div className="bg-gray-800 py-20 m-4 rounded-2xl">
                <div className="md:flex items-center justify-center gap-4 mx-auto w-5/6 h-full">
                    ...
                    <div className="sm:flex items-center justify-between w-full md:w-10/12 h-full mx-auto pl-[20px] sm:pl-0">
                        ...
                        >
                            <g><path className='fill-secondary-50' d="m24.15,0v48.31c0-6.67-5.4-12.08-12.07-12.08S0,41.64,0,48.31V0c0,6.67,5.41,12.08,12.08,12.08S24.15,6.67,24.15,0Z" /></g>
                        </svg>
